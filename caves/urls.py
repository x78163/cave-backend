...
urlpatterns = [
    ...
    path('<uuid:cave_id>/generate-stl/', views.cave_generate_stl, name='cave_generate_stl'),
    path('<uuid:cave_id>/cancel-stl/', views.cave_cancel_stl, name='cave_cancel_stl'),
    path('<uuid:cave_id>/stl-status/', views.cave_stl_status, name='cave_stl_status'),
